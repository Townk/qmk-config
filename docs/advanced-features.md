...
| ----- | ---- | ----- | ------------ | --- |
| 0 | BASE | Green | `BASE_GREEN` | `#347156` |
| 1 | QWT | Teal | `QWT_TEAL` | `#2F898B` |
| 2 | GAM1 | Blue | `GAME_1_BLUE` | `#355A93` |
| 3 | GAM2 | Deep blue | `GAME_2_BLUE` | `#0C7595` |
| 4 | NAV | Orange | `NAV_ORANGE` | `#D96702` |
| 5 | NUM | Blue | `NUM_BLUE` | `#41687E` |
| 6 | SYM | Coral | `HSV_CORAL` | `#FF7C4D` |
| 7 | FUN | Purple | `FUN_PURPLE` | `#605181` |
| 8 | MED | Yellow | `MED_YELLOW` | `#767709` |
| 14 | SYS | Red | `SYS_RED` | `#9C2927` |
| 15 | MBO | Magenta | `MBO_MAGENTA` | `#8C3396` |
